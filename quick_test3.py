...
if not reranker.check_server():
    ...
    print("  llama-server -m ~/.cache/huggingface/hub/models--jinaai--jina-reranker-v3-GGUF/snapshots/4bbace80cf59987f6fec850519012341c06810d5/jina-reranker-v3-Q4_K_M.gguf --rerank --port 8080")
    print("\n  # Option B: Copy model to current directory first")
    print("  cp ~/.cache/huggingface/hub/models--jinaai--jina-reranker-v3-GGUF/snapshots/4bbace80cf59987f6fec850519012341c06810d5/jina-reranker-v3-Q4_K_M.gguf .")
